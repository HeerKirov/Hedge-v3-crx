...
import { 
    faBookmark,
    faCalendar, faCalendarDay, faCalendarPlus, faCaretDown, faCaretRight, faCheck, faClose, faDownload, faFile, faFileInvoice,
...
library.add(
    ...
    faCalendarPlus, faCalendarDay, faRecordVinyl, faCheck, faCaretRight, faCaretDown, faFile
)
